...
folder_path = "/data_prep/"

mysql_id = "ict1"
mysql_pwd = "ict1"
db_name = "ict1"
table_name = "raw_bizinfo_20220830"
new_table_name = "prepV1_bizinfo_20220830"
...
with open("C:\\정부사업공고\\Download_Files\\SCHIDX_0&ATMIDX_0&SCHTYPE_제목&FTYPE_HWP&붙임1. 2022년 클라우드서비스 이용지원(바우처)_수요기관 모집공고.txt", "r", encoding="utf16") as f:
    a = f.readlines()


# # 이것은 2022.04.12 ~ 2022.04.55 과 같은 형식에서 기간을 추출하는 함수입니다.
# def get_date_V1(x -> rawdata):
#     # 코드 ...
#     # 리턴은 datetime 형식 (timestamp) 또는 없으면 None
#     return [접수시작일, 접수마감일]
